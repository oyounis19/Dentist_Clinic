        ...
        <div class="container-fluid py-4">
            <div class="row align-items-center text-center py-5">
                <div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
                    <img src="{{asset('Image/logo-8.png')}}" alt="" class="img-fluid" style="max-width: 90px;">
                </div>
                <div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
                    <img src="{{asset('Image/logo-9.png')}}" alt="" class="img-fluid" style="max-width: 140px;">
                </div>
                <div class="col-sm-4 col-lg-2 mb-5 mb-lg-0">
                    <img src="{{asset('Image/logo-10.png')}}" alt="" class="img-fluid" style="max-width: 140px;">
                </div>
                <div class="col-sm-4 col-lg-2 mb-5 mb-sm-0">
                    <img src="{{asset('Image/logo-11.png')}}" alt="" class="img-fluid" style="max-width: 140px;">
                </div>
                <div class="col-sm-4 col-lg-2 mb-5 mb-sm-0">
                    <img src="{{asset('Image/logo-12.png')}}" alt="" class="img-fluid" style="max-width: 100px;">
                </div>
                <div class="col-sm-4 col-lg-2">
                    <img src="{{asset('Image/logo-13.png')}}" alt="" class="img-fluid" style="max-width: 100px;">
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center bg-color-tertiary">
                    <div class="col-xl-6 p-0">
                        <div data-plugin-before-after data-plugin-options="{'before_label': '', 'after_label': ''}">
                            ...
                            <img src="{{asset('Image/before-after-1.jpg')}}" />
                            <!-- The after image is last -->
                            <img src="{{asset('Image/before-after-2.jpg')}}" />
                        </div>
                    </div>
                    <div class="col-xl-6 p-0 bg-color-tertiary text-center text-color-light">
                        <div class="d-flex align-items-center justify-content-center h-100 text-center custom-min-height-1">
                            ...
                            <div class="testimonial testimonial-style-2 px-lg-5">
                                <div class="d-block">
                                    <img height="80" width="80" src="{{asset('img/demos/dentist/icons/icon-8.svg')}}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-light mt-1'}" />
                                </div>
                                <blockquote>
